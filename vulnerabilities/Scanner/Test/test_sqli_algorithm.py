...
class TestSQLIAlgorithm(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vuln1 = VulnerabilityDescriptionEntity(name='error-based', severity=1, description='abc', recommendations='aaa')
    ...
    def test_generate_new_cookie(self):
        url = "http://localhost/bwapp/sqli_3.php"
        creds = CredentialsEntity(url, {"login": "bee", "password": "bug"})
